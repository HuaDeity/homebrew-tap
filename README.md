...
| --------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [vscode-langservers-extracted-zed](https://github.com/zed-industries/vscode-langservers-extracted) | HTML/CSS/JSON/ESLint/Markdown language servers with Zed's patched HTML server | `brew install HuaDeity/tap/vscode-langservers-extracted-zed` | Depends on `vscode-html-languageservice` below; the HTML server is Zed's fork with workspace-edit tag rename support. Renamed with a `-zed` suffix to avoid clashing with homebrew-core's `vscode-langservers-extracted`. |
| [vscode-html-languageservice](https://github.com/zed-industries/vscode-langservers-extracted) | HTML language server with Zed's workspace-edit tag rename patch | `brew install HuaDeity/tap/vscode-html-languageservice` | Zed-specific patch not accepted upstream; conflicts with `vscode-langservers-extracted` from homebrew-core. |
| [package-version-server](https://github.com/zed-industries/package-version-server) | Language server that handles hover information in `package.json` files | `brew install HuaDeity/tap/package-version-server` | [#281730](https://github.com/Homebrew/homebrew-core/pull/281730) Upstream repository does not yet meet homebrew-core's notability threshold (<30 forks, <30 watchers, <75 stars). |
...
| [EasyConnect](https://www.sangfor.com.cn/product-and-solution/sangfor-security/ssl-vpn) | Secure remote access solution for enterprises | I no longer use it; consider [docker-easyconnect](https://github.com/docker-easyconnect/docker-easyconnect) as a containerized alternative. |
