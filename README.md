...
| --------------------------------------------------------------------------------------- | ------------------------------------------------ | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [vscode-langservers-extracted](https://github.com/zed-industries/vscode-langservers-extracted) | HTML/CSS/JSON/ESLint/Markdown language servers with Zed's patched HTML server | `brew install HuaDeity/tap/vscode-langservers-extracted` | Depends on `vscode-html-languageservice` below; the HTML server is Zed's fork with workspace-edit tag rename support. |
